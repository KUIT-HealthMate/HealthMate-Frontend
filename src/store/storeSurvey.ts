...
export const surveys: Survey[] = [
    { id: 0, question: ["오늘의 근무(공부) 환경 및 시간은?"], candidates: ["규칙적이다.", "불규칙적이다."], multipleAble: false, limit: 0 },
    { id: 1, question: ["오늘 하루 쉬는 시간 없이", "근무/공부에 집중한 시간은?"], candidates: ["1시간 이하", "2~3시간", "4~5시간", "6~7시간", "8시간 이상"], multipleAble: false, limit: 0 },
    { id: 2, question: ["오늘 하루 커피를 몇 잔 마셨나요?"], candidates: ["0잔", "1잔", "2잔", "3잔 이상"], multipleAble: false, limit: 0 },
    { id: 3, question: ["오늘 운동을 몇 시간 하셨나요?"], candidates: ["0시간", "1~2시간", "3시간 이상"], multipleAble: false, limit: 0 },
    { id: 4, question: ["오늘 하루 동안 업무/공부 도중", "허리나 자세에 불편함을 느낀 적이 있나요?"], candidates: ["예", "아니오"], multipleAble: false, limit: 0 }
];

export const surveysMeal: Survey[] = [
    { id: 0, question: ["쿠잇 님은 오늘 언제 식사하셨나요?"], candidates: ["아침", "점심", "저녁"], multipleAble: true, limit: 3 },
    { id: 1, question: ["쿠잇 님이 오늘 먹은", " 음식 종류를 선택해주세요."], candidates: ["한식", "일식", "중식", "양식", "기타"], multipleAble: true, limit: 3 },
    { id: 2, question: ["쿠잇 님의 식사 시간은?"], candidates: ["규칙적이다.", "불규칙적이다."], multipleAble: false, limit: 0 },
    { id: 3, question: ["한 끼 식사에 소요된 시간을 알려주세요."], candidates: ["10분 ~ 20분 미만", "20분 이상 ~ 1시간 미만", "1시간 이상"], multipleAble: false, limit: 0 },
    { id: 4, question: ["식사를 할 때 소금이나 설탕 등", "조미료를 많이 섭취했나요?"], candidates: ["예", "아니오"], multipleAble: false, limit: 0 },
    { id: 5, question: ["식사를 하는 데 ", "TV나 스마트폰을 함께 봤나요?"], candidates: ["예", "아니오"], multipleAble: false, limit: 0 },
    { id: 6, question: ["오늘 하루 식사 중", "느낀 특이점이 있었나요?"], candidates: ["더부룩함", "복부 팽만", "식욕 저하", "폭식", "없음"], multipleAble: true, limit: 2 }
];
