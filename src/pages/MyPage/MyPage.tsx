...
export default function MyPage() {
  ...
  return (
    <div className={s.background}>
      <MyPageTopBar
        userName={profileInfo ? profileInfo.nickname : "쿠잇"}
        userProfileImg={profileInfo ? profileInfo.profileImage : "null"}
      />
      <CoinBlock deposit={profileInfo ? profileInfo.coin : 0} />
      <MyCommunity myPosts={12} myComments={8} savedPost={12} />
      <MyHealthProblems myProblems={profileInfo ? profileInfo.health : []} />
