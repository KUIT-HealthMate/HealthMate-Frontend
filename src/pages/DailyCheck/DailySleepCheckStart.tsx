  ...
  return (
    <div className={styles.startPage}>
      <div className={styles.startSleepCheck}>
        <h1 className={styles.startTitle} style={{ marginTop: `0` }}>
          거의 다 왔어요!
        </h1>
        <div className={styles.startText}>
          이번에는 쿠잇 님의{" "}
          <div className={styles.startGreeText}>수면 패턴</div>을 알아보려고
          해요.
        </div>
        <div className={styles.startText}>
          {"조금만 더 힘내서 답변해봐요:)"}
      ...
      <div className={styles.startSleepIcons}>
        ...
        ></img>
        <img
          src={dailySleepCheckStart}
          className={styles.startSleepIcon}
          alt="sleep"
        ></img>
      </div>
